 ...
 */
public class MinimizationOfMigration {
	...
	private static double maxUtilizationThreshold = 0.7;
	private static double minUtilizationThreshold = 0.3;
	...
	public static void main(String[] args) {
		...
		Log.printLine("Minimization of Migration finished!");
	}
	...
	private static PowerDatacenter createDatacenter(String name) throws Exception {
		...
		try {
			powerDatacenter = new PowerDatacenter(
					name,
					characteristics,
					new VmAllocationMinimizationOfMigration(hostList, maxUtilizationThreshold,minUtilizationThreshold),
