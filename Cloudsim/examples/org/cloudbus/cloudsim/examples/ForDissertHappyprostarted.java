...
public class ForDissertHappyprostarted
{
	...
	public static void main(String args[])
	{
		try {
			...
			vm.setHost(datacenter1.getHostList().get((j++ % datacenter1.getHostList().size())));
			vmlist.add(vm);				
			...
			Log.printLine("ForDissertHappyprostarted finished!");
		} catch (Exception e) {
			e.printStackTrace();
	...
	private static void printCloudletList(List<Cloudlet> list) {
		...
		System.out.println("Rejection rate = " + (1 - (1 / newvar)));
		System.out.println("Max = " + broker.getmax() + " Min = " + broker.getmin());
	}
}