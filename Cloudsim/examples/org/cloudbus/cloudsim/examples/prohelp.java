...
public class prohelp {
	...
	public static void main(String[] args) {
		Cloudlet cloudlet;
		Log.printLine("Starting prohelp...");
		...
		try {
			...
			newList.addAll(globalBroker.broker.getCloudletList());
			Log.printLine("Hi1 ");
			...
			Log.printLine("Counter: ");
			Log.printLine(counter);
			Log.printLine("prohelp finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	public static class GlobalBroker extends SimEntity {
		...
		public void processEvent(SimEvent ev) {
			...
			case CREATE_BROKER:
				...
				setVmList(createVM(getBroker().getId(), 1, 100)); //creating 1 vms
				setCloudletList(createCloudlet(getBroker().getId(), 1000, 100)); // creating 10 cloudlets
		...
		public void startEntity() {
			...
			schedule(getId(), counter, CREATE_BROKER);
		}
