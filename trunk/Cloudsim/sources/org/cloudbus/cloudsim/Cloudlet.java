...
/*    public Cloudlet(int cloudletId, long cloudletLength, int pesNumber,
			...
			UtilizationModel utilizationModelBw, final boolean record, int deadlineC) {
...
/********************************************************************************
 * sets vm group id to a cloudlet
 * @param tempVmGrpID
 * @return
 */
    public int setVmGrpId(int tempMips)
    {
    	//if(tempMips<0)	return false;
    	tempMips = tempMips/1000;
    	int tempVmGrpID = tempMips ; 
    	System.out.println("cloudlet " + this.cloudletId + " has group " + tempVmGrpID);
    	this.vmGrpId = tempMips+1;
    	return tempMips;
    	//return true;
    }
/*******************************************************************************
 * returns vm group id of a cloudlet
 * @return
 */
    public int getVmGrpId()
    {
    	return this.vmGrpId;
    }
/********************************************************************************
 ...
 * @return
 */
    public boolean setDeadline(final int tempDeadline)
    {
    	if(tempDeadline < 0)
    		return false;
...
/********************************************************************
 * sets mips for a cloudlet with deadline
 * @param tempMips
 * @return
 */
    public boolean setMips(final int tempMips)
    {
    	if(tempMips > 0)
    	{
    		this.mips = tempMips;
...
/*********************************************************************
 * returns Mips assigned for a cloudlet to complete within a deadline
 * @return
 */
    public int getMips()
    {
