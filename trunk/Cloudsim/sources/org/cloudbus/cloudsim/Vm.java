...
public class Vm {
	...
	/*public List<Vm> getVmList1(int grp)
	{
		List<Vm> myList = new ArrayList();
		for (Vm vm : getVmList())
		{
	...
	public boolean setGroupId(int tempGrId)
	{
		this.vmGroupId = tempGrId;
		return true;
	}
	 ...
	 * @param tempBusy
	 */
	public void setStatus(boolean tempBusy)
	{
		busy = tempBusy;
	}
	/*******************************************************
	 ...
	 * @return
	 */
	public boolean setStartTime(double tempTime)
	{
		if(tempTime<0) return false;  
		this.startTime = tempTime;
		return true;
	}
	
	public void setDeleteStatus(boolean status)
	{
		this.waitDelete = status;
	}
	...
	public int getvmQueue()
	{
		return this.vmQueue;
	}
	
	public void setvmQueue(int newvmQueue)
	{
		this.vmQueue = newvmQueue;
	}
	
	public void decrementVmQueue()
	{
		this.vmQueue--;
	}
	/**
