...
public class stocha {
	...
	private static double hostsNumber = 1;
	...
	private static PowerDatacenter createDatacenter(String name) throws Exception {
		...
		for (int i = 0; i < hostsNumber; i++) {
			...
			peList.add(new PowerPe(1, new PeProvisionerSimple(mips[i % mips.length]), new PowerModelLinear(maxPower, staticPowerPercent))); // need to store PowerPe id and MIPS Rating
			peList.add(new PowerPe(2, new PeProvisionerSimple(mips[i % mips.length]), new PowerModelLinear(maxPower, staticPowerPercent))); // need to store PowerPe id and MIPS Rating
			peList.add(new PowerPe(3, new PeProvisionerSimple(mips[i % mips.length]), new PowerModelLinear(maxPower, staticPowerPercent))); // need to store PowerPe id and MIPS Rating
