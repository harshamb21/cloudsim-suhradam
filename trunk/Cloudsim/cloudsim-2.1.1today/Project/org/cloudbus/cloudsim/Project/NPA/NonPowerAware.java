package org.cloudbus.cloudsim.Project.NPA;
...
import org.cloudbus.cloudsim.Project.ST.VmAllocationSingleThreshold;
	...
	private static PowerDatacenter createDatacenter(String name) throws Exception {
		...
		try {
			powerDatacenter = new PowerDatacenterNonPowerAware(
					name,
					characteristics,
					new VmAllocationSingleThreshold(hostList, 1.0),
