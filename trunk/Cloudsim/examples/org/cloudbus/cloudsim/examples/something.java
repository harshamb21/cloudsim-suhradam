...
public class something {
	...
	public static void main(String[] args) {
		Log.printLine("Starting something...");
...
//			Datacenter datacenter1 = createDatacenter("Datacenter_1");
			...
			vmList = createVM(brokerId, 1, 0); //creating 5 vms
			...
			Log.printLine("something finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	public static class GlobalBroker extends SimEntity {
		...
		public void processEvent(SimEvent ev) {
			...
			case CREATE_BROKER:
				...
				setVmList(createVM(getBroker().getId(), 0, 100)); //creating 5 vms
